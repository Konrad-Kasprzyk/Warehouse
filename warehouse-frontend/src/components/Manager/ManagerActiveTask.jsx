  ...
  function renderCancelCausesDropdownMenu() {
    return (
      <Dropdown>
        ...
        <Dropdown.Menu>
          <Dropdown.Item onClick={() => setCancelCause('LackOfSpace')}>
            LackOfSpace
          </Dropdown.Item>
          <Dropdown.Item onClick={() => setCancelCause('ProductsMissing')}>
            ProductsMissing
          </Dropdown.Item>
          <Dropdown.Item onClick={() => setCancelCause('Other')}>
            Other
          </Dropdown.Item>
          <Dropdown.Item onClick={() => setCancelCause(null)}>
            Clear
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
    ...
    <Container className="square border border-secondary rounded">
      <Row className="p-1">
        ...
        <Col md>
          ...
          <div>
            {startingShelf?.ShelfPurpose} shelf{' '}
            {props.task.TaskDetails.StartingShelfGtin}
          </div>
          <div>
            {destinationShelf?.ShelfPurpose} shelf{' '}
      ...
      <Row className="mb-3">
        ...
        <Col>
          {' '}
          {renderCancelCausesDropdownMenu()}{' '}
          <div className="mt-2">{cancelCause}</div>{' '}
        </Col>
      </Row>
